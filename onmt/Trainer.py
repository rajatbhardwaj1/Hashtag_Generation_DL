...
class Trainer(object):
    ...
    def train(self, train_iter, epoch, max_src_len, max_conv_len, report_func=None):
        """ Train next epoch.
        Args:
    ...
    def validate(self, valid_iter, max_src_len, max_conv_len):
        """ Validate model.
    ...
    def drop_checkpoint(self, opt, epoch, fields, valid_stats):
        ...
        model_name = '%s_acc_%.2f_ppl_%.2f_e%d.pt'% (opt.save_model, valid_stats.accuracy(), valid_stats.ppl(), epoch)
