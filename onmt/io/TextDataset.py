...
class TextDataset(ONMTDatasetBase):
    ...
    def __init__(self, fields, src_examples_iter, conversation_examples_iter, tgt_examples_iter,
                 num_src_feats=0, num_conversation_feats=0, num_tgt_feats=0,
        ...
        self.n_conversation_feats = num_conversation_feats
        ...
        if tgt_examples_iter is not None:
            ...
            examples_iter = (self._join_dicts(src, conversation) for src, conversation in
                             zip(src_examples_iter, conversation_examples_iter))
    ...
    def get_fields(n_src_features, n_tgt_features):
        ...
        fields["conversation"] = torchtext.data.Field(
            pad_token=PAD_WORD,
            include_lengths=True)
